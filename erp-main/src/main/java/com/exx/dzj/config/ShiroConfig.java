...
import com.exx.dzj.shiro.auth.JwtFilter;
import com.exx.dzj.shiro.auth.ResourceCheckFilter;
import com.exx.dzj.shiro.util.MyRealm;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        // 配置不会被拦截的链接 顺序判断
        // 登录接口排除
        filterChainDefinitionMap.put("/login/signIn", "anon");
        // 退出登录
        ...
        filterChainDefinitionMap.put("/newyeargiftexport/**", "anon");
    ...
    /**
     * 以下的 bean 都需要注入，否则启动失败
     * 报错：Parameter 0 of method shiroFilter in com.exx.dzj.config.ShiroConfig required a bean named 'authorizer' that could not be found.
     * @param myRealm
     * @return
     */
