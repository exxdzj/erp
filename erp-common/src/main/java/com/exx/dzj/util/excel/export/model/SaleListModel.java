...
public class SaleListModel extends BaseRowModel {
    ...
    @ExcelProperty(value = "送货地址", index = 8)
    ...
    @ExcelProperty(value = "所属公司", index = 11)
    private String subordinateCompanyName;

    @ExcelProperty(value = "优惠金额", index = 12)
    private String discountAmount;

    @ExcelProperty(value = "本次收款", index = 13)
    private String collectedAmount;

    @ExcelProperty(value = "收款账户", index = 14)
    private String collectionAccount;

    @ExcelProperty(value = "收款方式", index = 15)
    private String paymentMethod;

    @ExcelProperty(value = "收款条件", index = 16)
    private String collectionTerms;

    @ExcelProperty(value = "账期", index = 17)
    private String accountPeriod;

    @ExcelProperty(value = "收款人", index = 18)
    private String collectionUserName;

    @ExcelProperty(value = "到期日", index = 19, format = "yyyy-MM-dd")
    private Timestamp dueDate;

    @ExcelProperty(value = "存货服务", index = 20)
    private String stockName;

    @ExcelProperty(value = "地点", index = 21)
    ...
    @ExcelProperty(value = "折扣率%", index = 24)
    private String discountRate;

    @ExcelProperty(value = "折扣额", index = 25)
    private String goodsDiscountAmount;

    @ExcelProperty(value = "销售额", index = 26)
